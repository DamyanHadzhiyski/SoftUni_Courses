...
namespace CarDealer
{
    public class StartUp
    {
        ...
        private static T DeserializeXml<T>(T obj, string rootAttribute, string inputXml)
        {
            XmlSerializer serializer =
                new XmlSerializer(typeof(T), new XmlRootAttribute(rootAttribute));

            T deserialized = (T)serializer.Deserialize(new StringReader(inputXml));
